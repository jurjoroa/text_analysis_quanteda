...
## First Step: What is Quanteda?

::: columns
::: {.column width="50%"}
Quanteda is an R package for managing and analyzing textual data.

It was developed by Kenneth Benoit, Kohei Watanabe, and other contributors.

Oficial information about the package: <http://quanteda.io/>

It is also available on CRAN: <https://cran.r-project.org/web/packages/quanteda/index.html>
:::
:::

## Quanteda - Tutorials and guides

::: {.column width="50%"}
Actual major version: 3.0 - For detailed information about this major release: [https://github.com/quanteda/quanteda/blob/master/NEWS.md#quanteda-30](https://github.com/quanteda/quanteda/blob/master/NEWS.md)

A simple and effective initial guide:

*Another A Beginner's Guide to Text Analysis with quanteda* (available in <https://data.library.virginia.edu/a-beginners-guide-to-text-analysis-with-quanteda/>)

Some other basic and advanced tutorials: <https://tutorials.quanteda.io/>
:::

## Quanteda - Three main elements

::: {.column width="50%"}
The corpus - it is the library: used to load the texts (multiple original sources) and process them. It accepts many types of sources like text files (txt), csv tables, XML, and JSON data. It's the original data that will be pre-processed and analyzed.

Tokens: each token stores each word of the text (depending on the purpose of the analysis, it can be configured to store every sentence or even every character). Based on it, Quanteda identifies frequencies and biases.

Document Feature Matrix -- DFM: It is a matrix of documents by features. It allows the removal of stopwords (I, he, she, our...) and punctuation, sorting data, converting strings to lowercase/uppercase, and identifying the most frequent features, for instance.
:::

## Quanteda - Two common forms of analysis

::: {.column width="50%"}
Sentiment analysis: identify the emotion or the opinion of the text, based on the words and sentences used.

Is it a happy speech? Does the book seem to be optimistic? Is it a scary movie?

Content analysis: Evaluates the frequency of word use and looks for trends.

Are there similarities between the website's daily news? What is the correlation between the book's chapters? What are the bias of Twitter posts and the words frequently used?

**Important**: Quanteda can do these analyses for many languages like Russian, English, Spanish, German, Arabic, Chinese, Japanese...
:::

# Let's see how it works in a real project!
...
Quarto enables you to weave together content and executable code into a finished presentation. To learn more about Quarto presentations see <https://quarto.org/docs/presentations/>. Quarto enables you to weave together content and executable code into a finished presentation. To learn more about Quarto presentations see <https://quarto.org/docs/presentations/>.
:::

::: {.column width="50%"}
Quarto enables you to weave together content and executable code into a finished presentation. To learn more about Quarto presentations see <https://quarto.org/docs/presentations/>. Quarto enables you to weave together content and executable code into a finished presentation. To learn more about Quarto presentations see <https://quarto.org/docs/presentations/>. Data cleaning to obtain clean tables
